...
/**
 * PhotoGallery is an easy to use, simple to manage, web photo gallery written in
 * PHP. PhotoGallery does not require a database and supports JPEG, GIF and PNG
 * file types. Simply upload your images and PhotoGallery will automatically
 * generate thumbnails and output standards complaint XHTML markup on the fly.
 *
 * This software is distributed under the MIT License
 * http://www.opensource.org/licenses/mit-license.php
 *
 * More info available at http://www.PhotoGallery.net
 *
 ...
 * @link https://github.com/PhotoGallery/PhotoGallery Cannonical source URL
 */
class PhotoGallery {
    ...
    /**
     * PhotoGallery construct function. Runs on object creation.
     */
    public function __construct() {
        ...
        if ($this->_config['debugging']) {
            ...
            if (!file_exists($this->_debugLog)) {
                ...
                $ugVersion  = 'PhotoGallery v' . PhotoGallery::VERSION;
            ...
            set_error_handler("PhotoGallery::_errorHandler");
